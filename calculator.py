...
button_4 = tk.Button(button_frame,text="Del",width=3,command= del_function,font=("Arial",20),background="orange")
button_4.grid(row=0,column=3)
button_5 = tk. Button(button_frame,text="AC",width=3,command= ac_function,font=("Arial",20),background="orange")
...
button_10 = tk.Button(button_frame,text=" = ",width=3,command= lambda : calculate(1,'='),font=("Arial",20),background="yellow")
button_10.grid(row=1,column=4)
button_11 = tk.Button(button_frame,text=" 9 ",width=3,command= lambda : calculate(value_seperator,9),font=("Arial",20),background="lightgray")
button_11.grid(row=2,column=0)
button_12 = tk.Button(button_frame,text=" 8 ",width=3,command= lambda : calculate(value_seperator,8),font=("Arial",20),background="lightgray")
button_12.grid(row=2,column=1)
button_13 = tk.Button(button_frame,text=" 7 ",width=3,command= lambda : calculate(value_seperator,7),font=("Arial",20),background="lightgray")
button_13.grid(row=2,column=2)
button_14 = tk.Button(button_frame,text=" 6 ",width=3,command= lambda : calculate(value_seperator,6),font=("Arial",20),background="lightgray")
button_14.grid(row=2,column=3)
button_15 = tk.Button(button_frame,text=" 5 ",width=3,command= lambda : calculate(value_seperator,5),font=("Arial",20),background="lightgray")
button_15.grid(row=2,column=4)
button_16 = tk.Button(button_frame,text=" 4 ",width=3,command= lambda : calculate(value_seperator,4),font=("Arial",20),background="lightgray")
button_16.grid(row=3,column=0)
button_17 = tk.Button(button_frame,text=" 3 ",width=3,command= lambda : calculate(value_seperator,3),font=("Arial",20),background="lightgray")
button_17.grid(row=3,column=1)
button_18 = tk.Button(button_frame,text=" 2 ",width=3,command= lambda : calculate(value_seperator,2),font=("Arial",20),background="lightgray")
button_18.grid(row=3,column=2)
button_19 = tk.Button(button_frame,text=" 1 ",width=3,command= lambda : calculate(value_seperator,1),font=("Arial",20),background="lightgray")
button_19.grid(row=3,column=3)
button_20 = tk.Button(button_frame,text=" 0 ",width=3,command= lambda : calculate(value_seperator,0),font=("Arial",20),background="lightgray")
